...
extension DeveloperToolsSupport.ImageResource {
    ...
    static let bird = DeveloperToolsSupport.ImageResource(name: "bird", bundle: resourceBundle)

    /// The "brick" asset catalog image resource.
    static let brick = DeveloperToolsSupport.ImageResource(name: "brick", bundle: resourceBundle)
...
extension AppKit.NSImage {
    ...
    /// The "bird" asset catalog image.
    static var bird: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .bird)
#else
        .init()
    ...
    /// The "brick" asset catalog image.
    static var brick: AppKit.NSImage {
#if !targetEnvironment(macCatalyst)
        .init(resource: .brick)
#else
        .init()
...
extension UIKit.UIImage {
    ...
    /// The "brick" asset catalog image.
    static var brick: UIKit.UIImage {
#if !os(watchOS)
        .init(resource: .brick)
#else
        .init()
